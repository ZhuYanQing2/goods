...
<div class="divBody">
  ...
  <div class="divCenter">
  <form action="<c:url value='/UserServlet'/>" method="post" id="registFrom">
    <input type="hidden" name="method" value="regist"/>
   	 <table>
      <tr>
        <td class="tdLabel">用户名：</td>
        <td class="tdInput">
          <input type="text" name="loginname" id="loginname" class="input" value="${from.loginname}"/>
        </td>
        <td class="tdError">
      ...
      <tr>
        ...
        <td class="tdInput">
          <input type="password" name="loginpass" id="loginpass" class="input" value="${from.loginpass}"/>
        </td>
        <td class="tdError">
      ...
      <tr>
        ...
        <td class="tdInput">
          <input type="password" name="reloginpass" id="reloginpass" class="input" value="${from.reloginpass }"/>
        </td>
        <td class="tdError">
      ...
      <tr>
        ...
        <td class="tdInput">
          <input type="text" name="email" id="email" class="input" value="${from.email}"/>
        </td>
        <td class="tdError">
      ...
      <tr>
        ...
        <td class="tdInput">
          <input type="text" name="verifyCode" id="verifyCode" class="input" value="${from.verifyCode }"/>
        </td>
        <td class="tdError">
